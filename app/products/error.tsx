  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-3xl font-light text-[#3d2c2c] mb-3" style={{ fontFamily: 'Cormorant Garamond, Georgia, serif' }}>
          Products unavailable
        </h2>
        <p className="text-sm text-[#9d7e7e] font-light mb-6 leading-relaxed">
          We couldn&apos;t load our product catalog right now. Please try again.
        </p>
        <div className="flex items-center justify-center gap-3">
          ...
          <Link href="/" className="px-6 py-3 border border-[#ffc9d5] text-[#6b4c4c] text-sm font-medium rounded-full hover:border-[#b76e79] hover:text-[#b76e79] transition-all duration-300">
            Go Home
          </Link>
        </div>
      </div>
