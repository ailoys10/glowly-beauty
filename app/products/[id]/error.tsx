    ...
    <div className="min-h-[70vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <Link href="/products" className="px-6 py-3 border border-[#ffc9d5] text-[#6b4c4c] text-sm font-medium rounded-full hover:border-[#b76e79] hover:text-[#b76e79] transition-all duration-300">
            All Products
          </Link>
        </div>
      </div>
